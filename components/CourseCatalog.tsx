          ...
          <div className="grid gap-4 md:grid-cols-2">
            {courses.map((item, index) => (
              <Link
                ...
                className="group flex min-h-[285px] flex-col border border-slate-200 bg-white p-7 transition hover:-translate-y-1 hover:border-[#c99b48] hover:shadow-[0_18px_45px_rgba(7,31,62,0.09)]"
              >
