...
export const metadata = createPageMetadata(
  "关于中心",
  "十余年专注语言教育，以系统课程、专业教学和持续反馈，服务学生、职场人士与企事业单位的多元学习目标。",
  "/about",
);
      ...
      <section className="py-24">
        <div className="shell grid gap-14 lg:grid-cols-[1fr_1fr] lg:items-start">
          ...
          <div className="prose-page">
            ...
            <p className="mt-7">
              浙江财经大学（文华校区）语言中心依托高校教育资源与开放合作平台，面向学生、职场人士及企事业单位开展多层次语言学习与培训服务。
            </p>
            <p>
              十余年来，中心从英语基础能力课程出发，课程已涵盖通用英语、商务沟通、留学与考试辅导、法语、日语、韩语以及企业定制培训，累计服务学员超过一万人。
            </p>
            <p>
