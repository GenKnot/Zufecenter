...
const copies: DetailCopy[] = [
  ...
  { parent: "faculty", slug: "chinese", title: "International Chinese Teaching Team", summary: "Teaching Chinese as an international language, connecting pronunciation, characters, grammar and real communication.", points: ["Pinyin, tones, characters and basic expression for a first start", "HSK preparation from general ability through to focused exam work", "Academic and professional Chinese for study, research and the workplace"] },
