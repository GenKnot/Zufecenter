...
const copies: DetailCopy[] = [
  ...
  { parent: "collaboration", slug: "campus", title: "Campus Partnerships", summary: "Co-design courses, workshops and cultural activities for the needs of a particular student community.", points: ["Begin with the participants, academic context and desired outcome", "Combine language learning with disciplines, student life or campus initiatives", "Choose a format that can be delivered and reviewed realistically"] },
  ...
  { parent: "collaboration", slug: "international", title: "International Exchange", summary: "Design exchange around dialogue and a meaningful shared task rather than a ceremonial visit.", points: ["Prepare participants with the language and context needed to contribute", "Create structured opportunities for questions, collaboration and mutual learning", "Use a shared outcome to give the exchange continuity and educational value"] },
];
