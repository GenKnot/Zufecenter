...
export const koSections: LocalizedSection[] = [
  ...
  },
  {
    ...
    description:
      "명확한 학습 요구를 가진 파트너와 과정, 워크숍, 교원 교류, 문화 프로그램을 개발합니다.",
    introTitle: "협력은 하나의 구체적인 과제에서 시작할 수 있습니다",
    intro: [
      "단 한 번의 워크숍이 필요한 파트너도 있고, 학기 과정이나 지속적인 개발 프로그램이 필요한 파트너도 있습니다. 먼저 참가자와 원하는 성과를 이해하는 것에서 시작합니다.",
      "내용, 교수 팀, 제공 형식, 검토 방법은 그 공유된 요건을 중심으로 설계됩니다.",
    ],
    image: "/images/meeting-room.jpg",
    cards: [
      { title: "캠퍼스 협력", label: "과정·활동", text: "특정 학생 그룹을 위한 공동 과정, 강연, 워크숍, 언어문화 활동." },
      { title: "기업 협력", label: "직무 요구", text: "직무, 고객 소통, 국제 비즈니스 상황에서 도출한 연수." },
      { title: "국제 교류", label: "공동 학습", text: "대화와 의미 있는 공동 과제를 중심으로 구성된 언어 교류 프로젝트." },
    ],
    closingTitle: "협력은 관찰 가능한 성과로 이어져야 합니다",
    closingText:
      "명확한 목표와 실용적인 검토 과정이 양측이 참가자가 얻은 것과 개선해야 할 점을 파악하는 데 도움이 됩니다.",
    ctaLabel: "협력 논의 시작하기",
  },
  {
    slug: "news",
