...
const copies: DetailCopy[] = [
  ...
  { parent: "collaboration", slug: "international", title: "Échange international", summary: "Concevoir l'échange autour du dialogue et d'une tâche commune significative plutôt qu'une visite cérémonielle.", points: ["Préparer les participants avec la langue et le contexte nécessaires pour contribuer", "Créer des occasions structurées de questions, de collaboration et d'apprentissage mutuel", "Utiliser un résultat partagé pour donner à l'échange continuité et valeur éducative"] },
];
