...
const copies: DetailCopy[] = [
  { parent: "about", slug: "leadership", title: "センター長 武鑫教授", summary: "武鑫教授は本センターのセンター長として、金融イノベーション、国際サービス、フランス語金融複合人材育成を推進しています。", points: ["金融イノベーション、資本市場、社会経済発展の研究", "企業国際化と越境金融への支援", "フランス語、金融、異文化能力を統合した人材育成"] },
  ...
  { parent: "about", slug: "facilities", title: "測定設備", summary: "コンピュータ試験用ブース、仕切り、音声機器が語学評価とマルチメディア授業を支えます。", points: ["コンピュータ試験と段階的な語学評価に対応したワークステーション", "ヘッドセットがリスニング入力と口頭回答練習を支える", "仕切られた座席が試験、模擬演習、集中練習での干渉を抑える"] },
  ...
  { parent: "faculty", slug: "chinese", title: "国際中国語教育チーム", summary: "国際的な言語としての中国語教育。発音、漢字、文法、実際のやり取りをつなぎます。", points: ["ピンイン、声調、漢字、基本表現から始める入門", "HSK 対策——総合力から試験の重点対策まで", "学習・研究・仕事のための学術／職業中国語"] },
  ...
  { parent: "collaboration", slug: "campus", title: "大学間連携", summary: "特定の学生コミュニティのニーズに合わせて、コース、ワークショップ、語学評価支援を共同設計します。", points: ["参加者・学術的背景・望ましい成果から出発する", "語学学習を専門分野・学生生活・キャンパスの取り組みと組み合わせる", "CEFRなどの国際基準に沿った教育・学術評価リソースを共有する"] },
  ...
  { parent: "collaboration", slug: "international", title: "国際交流", summary: "国際教育リソースを語学力向上、学術基準、評価サービスと結びつけます。", points: ["大学、公式教育機関、組織パートナーとの協力を構築する", "明確な学術管理と一貫した評価期待に基づいて進める", "語学力向上と国際評価準備のための高水準プラットフォームを支える"] },
];
