...
export const resourcePages: ContentPage[] = [
  {
    ...
    sections: [
      { title: "入门建议", paragraphs: ["先明确使用场景和可投入时间，再选择课程；不要同时堆叠过多材料。"] },
      { title: "日常节奏", paragraphs: ["固定短时学习、定期长时练习、保留输出任务，并记录自己仍然无法完成的表达。"] },
    ],
    image: "/images/library.jpg",
  },
  {
    ...
    heroImage: "/images/library-hero.png",
    intro: ["课程资料包括班级手册、阶段学习清单、课堂讲义和自主练习工具。公开课程信息可在语种与班级页面查看，配套材料则按课程进度向学员发放。"],
    highlights: [
  ...
  },
  {
    ...
    sections: [
      { title: "如何选择语种和课程？", paragraphs: ["结合使用目标、兴趣、可投入时间与现有基础选择。拿不准时可先参加公开课或学习咨询。"] },
      { title: "错过课程可以补课吗？", paragraphs: ["补课方式与资料使用按所报班型执行，报名说明中会列明相应安排。"] },
  ...
  },
  {
    ...
    sections: [
      { title: "学习支持", paragraphs: ["课前可查看主题材料，课后可完成重点练习并保留阶段成果；需要测评和个别反馈的项目，会在课程安排中明确说明。"] },
      { title: "使用原则", paragraphs: ["数字工具应减少重复事务、增加反馈机会，而不是制造额外打卡负担。"] },
    ],
    image: "/images/study-desk.jpg",
  },
];
