...
const copies: DetailCopy[] = [
  ...
  { parent: "collaboration", slug: "campus", title: "캠퍼스 협력", summary: "특정 학생 커뮤니티의 요구를 위해 과정, 워크숍, 문화 활동을 공동 설계합니다.", points: ["참가자, 학업 맥락, 원하는 성과에서 출발하기", "언어 학습을 전공 분야, 학생 생활, 캠퍼스 이니셔티브와 결합하기", "현실적으로 진행하고 평가할 수 있는 형식 선택하기"] },
  ...
  { parent: "collaboration", slug: "international", title: "국제 교류", summary: "의례적인 방문이 아닌 대화와 의미 있는 공동 과제를 중심으로 교류를 설계합니다.", points: ["참가자가 기여하기 위해 필요한 언어와 맥락 준비하기", "질문, 협업, 상호 학습을 위한 구조화된 기회 만들기", "공유된 성과를 사용하여 교류에 지속성과 교육적 가치 부여하기"] },
];
